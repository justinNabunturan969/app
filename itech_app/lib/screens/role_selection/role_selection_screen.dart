  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        // Small delay so the user actually sees the selection feedback
        // before the page transition kicks in. Without it the highlight
        // is invisible — the new screen lands before the eye registers it.
